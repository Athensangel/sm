	...
	<body>
		<div class="admin-main">
			...
			<fieldset class="layui-elem-field">
				...
				<form action="${pageContext.request.contextPath}/orders/updateOrders" method="post">
				<input type="hidden" name="toid" value="${orders.toid}"/>
					<table class="site-table table-hover">
						<thead>
							<tr>
								<th width="5%"><input type="checkbox" id="selected-all"></th>
								<th>客户姓名</th>
								<th>客户地址</th>
								<th>客户电话</th>
								<th>客户邮箱</th>
						...
						<tbody>
							<tr>
								...
								<td>
									<%-- <a href="${pageContext.request.contextPath}/productServletUp?toid=${product.toid}" class="layui-btn layui-btn-mini">编辑</a> --%>
								<input class="layui-btn layui-btn-mini" type="submit" value="编辑" />
								</td>
							</tr>
						</tbody>
					</table>
